...
{
    public partial class Pract_Exam : Form
    {
        SqlConnection cn;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,PC1,P1,SC3,SN3,PC2,P2,SC4,SN4,PC3,P3,SC5,SN5,PC5,P5  from FIT";
            ...
            {
                s = "select UID,SC6,SN6,PC6,P6,SC7,SN7,PC7,P7,SC8,SN8,PC8,P8,SC9,SN9,PC9,P9,SC10,SN10,PC10,P10  from FIT";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,PC1,P1,SC3,SN3,PC2,P2,SC4,SN4,PC3,P3,SC5,SN5,PC5,P5  from SIT";
            ...
            {
                s = "select UID,SC6,SN6,PC6,P6,SC7,SN7,PC7,P7,SC8,SN8,PC8,P8,SC9,SN9,PC9,P9,SC10,SN10,PC10,P10  from SIT";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,PC1,P1,SC3,SN3,PC2,P2,SC4,SN4,PC3,P3,SC5,SN5,PC5,P5  from TIT";
            ...
            {
                s = "select UID,SC6,SN6,PC6,P6,SC7,SN7,PC7,P7,SC8,SN8,PC8,P8,SC9,SN9,PC9,P9,SC10,SN10,PC10,P10  from TIT";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,PC1,P1,SC3,SN3,PC2,P2,SC4,SN4,PC3,P3,SC5,SN5,PC5,P5  from FYCS";
            ...
            {
                s = "select UID,SC6,SN6,PC6,P6,SC7,SN7,PC7,P7,SC8,SN8,PC8,P8,SC9,SN9,PC9,P9,SC10,SN10,PC10,P10  from FYCS";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,PC1,P1,SC3,SN3,PC2,P2,SC4,SN4,PC3,P3,SC5,SN5,PC5,P5 from SYCS";
            ...
            {
                s = "select UID,SC6,SN6,PC6,P6,SC7,SN7,PC7,P7,SC8,SN8,PC8,P8,SC9,SN9,PC9,P9,SC10,SN10,PC10,P10  from SYCS";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,PC1,P1,SC3,SN3,PC2,P2,SC4,SN4,PC3,P3,SC5,SN5,PC5,P5  from TYCS";
            ...
            {
                s = "select UID,SC6,SN6,PC6,P6,SC7,SN7,PC7,P7,SC8,SN8,PC8,P8,SC9,SN9,PC9,P9,SC10,SN10,PC10,P10  from TYCS";
        ...
        private void Pract_Exam_Load(object sender, EventArgs e)
        {
