...
{
    public partial class Internal_exam : Form
    {
        SqlConnection cn;
        ...
        public Internal_exam()
        {
            InitializeComponent();
        }

        private void Internal_exam_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,I2,SC3,SN3,I3,SC4,SN4,I4,SC5,SN5,I5  from FIT";
            ...
            {
                s = "select UID,SC6,SN6,I6,SC7,SN7,I7,SC8,SN8,I8,SC9,SN9,I9,SC10,SN10,I10  from FIT";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,I2,SC3,SN3,I3,SC4,SN4,I4,SC5,SN5,I5  from SIT";
            ...
            {
                s = "select UID,SC6,SN6,I6,SC7,SN7,I7,SC8,SN8,I8,SC9,SN9,I9,SC10,SN10,I10  from SIT";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,I2,SC3,SN3,I3,SC4,SN4,I4,SC5,SN5,I5  from TIT";
            ...
            {
                s = "select UID,SC6,SN6,I6,SC7,SN7,I7,SC8,SN8,I8,SC9,SN9,I9,SC10,SN10,I10  from TIT";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,I2,SC3,SN3,I3,SC4,SN4,I4,SC5,SN5,I5  from FYCS";
            ...
            {
                s = "select UID,SC6,SN6,I6,SC7,SN7,I7,SC8,SN8,I8,SC9,SN9,I9,SC10,SN10,I10  from FYCS";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,I2,SC3,SN3,I3,SC4,SN4,I4,SC5,SN5,I5 from SYCS";
            ...
            {
                s = "select UID,SC6,SN6,I6,SC7,SN7,I7,SC8,SN8,I8,SC9,SN9,I9,SC10,SN10,I10  from SYCS";
            ...
            {
                s = "select UID,SC1,SN1,I1,SC2,SN2,I2,SC3,SN3,I3,SC4,SN4,I4,SC5,SN5,I5  from TYCS";
            ...
            {
                s = "select UID,SC6,SN6,I6,SC7,SN7,I7,SC8,SN8,I8,SC9,SN9,I9,SC10,SN10,I10  from TYCS";
